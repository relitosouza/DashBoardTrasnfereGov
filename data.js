// Banco de dados simulado inicial para o Painel de Controle TransfereGov (Google Stitch)
...
// Carregar propostas salvando/lendo do localStorage
function getProposals() {
  const data = localStorage.getItem("transferegov_proposals");
  if (!data) {
    localStorage.setItem("transferegov_proposals", JSON.stringify(INITIAL_PROPOSALS));
...
function saveProposals(proposals) {
  localStorage.setItem("transferegov_proposals", JSON.stringify(proposals));
}

// Configurações e Parâmetros administrativos simulados
const APP_CONFIG = {
  users: [
